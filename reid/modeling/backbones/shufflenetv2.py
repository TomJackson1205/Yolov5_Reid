...
model_urls = {
    ...
    'shufflenetv2_2.0x': '/home/xianyu/PycharmProjects/my_yolov5/weight/shuffulenet/ShuffleNetV2.2.0x.pth.tar',
}
        ...
        if pretrain:
            ...
            if url is not None:
                ...
                if torch.cuda.is_available():
                    ...
                    pretrained_state_dict = torch.load(url,map_location=torch.device('cpu'))
...
if __name__ == "__main__":
    ...
    # test_data = torch.rand(5, 3, 320, 320)#256, 128
    test_data = torch.rand(2, 3, 256, 128)
    test_outputs = model(test_data)
    print(test_outputs.shape)
    # for out in test_outputs:
    #     print(out.size())
        #torch.Size([2, 2048, 16, 8])
